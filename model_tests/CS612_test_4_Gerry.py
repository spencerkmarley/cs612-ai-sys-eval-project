...
from models.definitions import CIFAR10_Noise_Net
...
subject_model_filename = 'models/subject/cifar10_backdoored_1.pt'
...
#
FORCE_RELOAD = False
save_filename = os.path.join('models', 'noised_CIFAR10NET.pt')
...
model_noise = load_model(CIFAR10_Noise_Net, './models/noised_CIFAR10NET.pt')
